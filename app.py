...
def start_location_flow(event, flow_type):
    ...
    send_line_message(event.reply_token, [{"type": "text", "text": "都道府県を選択してください。", "quickReply": quick_reply.to_dict()}])
...
def handle_message(event):
    ...
    if current_step == "pref":
        ...
        if selected_pref:
            ...
            send_line_message(event.reply_token, [{"type": "text", "text": "最後に都市名を選択してください。", "quickReply": quick_reply.to_dict()}])
        else:
